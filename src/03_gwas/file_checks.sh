...
for CHR in `seq 1 26`
do
#	f_path=${GWAS_FOLDER}/ukb24893_v2.${TRAIT}.zerosex.${TRAIT}_c${CHR}.glm.linear.gz;
#	m_path=${GWAS_FOLDER}/ukb24893_v2.${TRAIT}.onesex.${TRAIT}_c${CHR}.glm.linear.gz;
	f_path=${GWAS_FOLDER}/ukb24893_v2.${TRAIT}.onesex.PHENO1_c${CHR}.glm.linear.gz;
