...
python gwas.py --run-array --run-now --mem=51200 --cores=8 --population ${pop} --pheno ${phe_dir}/${trait}.phe --out ${out_dir} --log-dir ${BASE_DIR}/logs --sex-div True --keep-sex ${sex} --keep-sex-file ${BASE_DIR}/phefiles/${sex}.keep --include-x True
